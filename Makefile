...
check:
	...
	@echo "Running EL-compliance regression test (catches tables that reintroduce hand-coded postfix)..."
	go test -count=1 -run "^TestTaxReturn_NoLegacyPostfix$$" ./pkg/dtrules/
	@echo "check passed."
