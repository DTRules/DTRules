...
import (
	...
	"github.com/DTRules/DTRules/pkg/dtrules/ruleset"
)
...
func compileTokenToBytecode(bc *dtrules.BytecodeChunk, token string) error {
	...
	// Handle literal names starting with /. A lone "/" is the
	// integer-division operator, not an empty literal name (#1241).
