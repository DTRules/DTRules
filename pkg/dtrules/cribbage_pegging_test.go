...
func TestCribbagePegging(t *testing.T) {
	cases := []struct {
		...
		{name: "trips making fifteen score both", stack: []int{5, 5, 5}, count: 15, total: 8},
		{name: "run with fifteen off an ace", stack: []int{9, 1, 2, 3}, count: 15, total: 5},
		{name: "face cards run by rank, count by value", stack: []int{11, 12, 13}, count: 30, total: 3},
		{name: "trailing pair beside a near-run", stack: []int{5, 4, 4}, count: 13, total: 2},
