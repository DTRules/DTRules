...
optSemi
    ...
    | CONTEXT findclause optSemi                            # contextFindClause
...
// EBL-specific: FIND entity IN array THEN context
findclause
    : FIND typedEntity IN arrayExpr THEN contextForTable
    ;
...
bexpr
    ...
    // EBL-specific: is within check (e.g., page_number is within excluded_chapters)
    | iexpr ISWITHIN arrayExpr                              # boolIsWithin
