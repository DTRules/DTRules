 ...
 */
public class EBLAntlr implements ICompiler {
    ...
    private HashMap<String, EBLTypeResolver.RLocalType> localtypes = new HashMap<String, EBLTypeResolver.RLocalType>();
    ...
    private String compile(String s) throws RulesException {
        ...
        EBLLexer lexer = new EBLLexer(CharStreams.fromString(s));
        ...
        // Parse
        EBLParser.DoneContext tree = parser.done();
        ...
        EBLTypeResolver typeResolver = new EBLTypeResolver(session, types, localtypes);
        EBLCompilerVisitor visitor = new EBLCompilerVisitor(typeResolver);
