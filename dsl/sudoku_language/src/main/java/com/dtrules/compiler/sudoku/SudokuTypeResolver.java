...
/**
 * Resolves identifier types for the ANTLR 4 Sudoku parser.
 * Replaces the functionality of TokenFilter from the JFlex/CUP implementation.
 */
public class SudokuTypeResolver {
    ...
    public SudokuTypeResolver(IRSession session, HashMap<RName, IRType> types, HashMap<String, RLocalType> localtypes) {
        this.types = types;
    ...
    private int identType(String ident, String entity) {
        SLType type = (SLType) types.get(RName.getRName(ident, true));
