...
// Helper rule for optional terminal semicolon
optSemi
    : SEMI?
    ;
...
statement
    ...
    | separator  // Allow null statement
    ;
...
forallctl
    ...
    | FORALL arrayExpr IN THIS iexpr                        # forallInThis
    | FORALL arrayExpr IN ALL arrayExpr IN THIS iexpr       # forallInAllInThis
    ;

forblock
    : arrayExpr block                                       # forblockSimple
    | eexpr IN arrayExpr block                              # forblockInArray
    | eexpr IN arrayExpr WHERE bexpr block                  # forblockInArrayWhere
    | arrayExpr WHERE bexpr block                           # forblockArrayWhere
    | eexpr AND ITS eexpr IN arrayExpr block                # forblockIts
    | eexpr AND ITS eexpr IN arrayExpr WHERE bexpr block    # forblockItsWhere
    ;
...
firstblock
    : FOR FIRST OF arrayExpr WHERE bexpr THEN block ELSEIFNONEAREFOUND block  # firstBlockElse
    | FOR FIRST OF arrayExpr AND ITS eexpr WHERE bexpr THEN block ELSEIFNONEAREFOUND block # firstBlockItsElse
    | forfirstctl THEN block                                # firstBlockCtl
    ;
...
block
    ...
    | FORALL forblock                                       # blockForall
    | firstblock                                            # blockFirst
    | IF ifblock                                            # blockIf
    | block separator                                       # blockSep
...
strexpr
    ...
    | STRING VALUE_OF operatorstatements                    # strValueOfOp
    ...
    | LPAREN STRING RPAREN fexpr                            # strValueOfFloat
    | LPAREN STRING RPAREN iexpr                            # strValueOfInt
    | LPAREN STRING RPAREN dexpr                            # strValueOfDate
    | CVS LPAREN bexpr RPAREN                               # strCvsOfBool
    ...
    | GET CURRENT_DATE                                      # strCurrentDate
...
fexpr
    ...
    | DOUBLE VALUE_OF operatorstatements                    # floatValueOfOp
    ...
    | SUM_OF fexpr IN arrayExpr                             # floatSumOf
    ;
...
iexpr
    ...
    | LONG VALUE_OF operatorstatements                      # intValueOfOp
...
bexpr
    ...
    | BOOLEAN VALUE_OF operatorstatements                   # boolValueOfOp
