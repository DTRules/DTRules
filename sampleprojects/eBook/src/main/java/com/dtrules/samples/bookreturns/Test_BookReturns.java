...
public class Test_BookReturns extends ATestHarness {

    public static String path  = System.getProperty("user.dir") + "/";
    public static String parms = path + "/rs_returns/xml/testParms.xml";

    public Test_BookReturns() {
        try {
            load(parms);
        } catch (Exception e) {
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        Test_BookReturns t = new Test_BookReturns();
        t.runTests(); // Run the tests.
        t.writeDecisionTables("BookReturns", null, true, 10);
